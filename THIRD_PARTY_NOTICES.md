...
| 组件 | 用途 | 主要许可证 |
| --- | --- | --- |
| Kotlin / kotlinx.coroutines / kotlinx.serialization / kotlinx-collections-immutable | 语言与异步/序列化/不可变集合基础 | Apache-2.0 |
...
| OkHttp（含 logging-interceptor） | 网络传输与日志拦截 | Apache-2.0 |
...
| JUnit 4 / Google Truth / Turbine / Robolectric / androidx.test（仅测试） | 单元测试 | Apache-2.0（JUnit: EPL-1.0） |
